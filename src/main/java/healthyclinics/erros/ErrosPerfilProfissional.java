...
public class ErrosPerfilProfissional {
    ...
    public ErrosPerfilProfissional(JLayeredPane layeredPane) {
    ...
    public void mostrarErroCrm() {
        ...
        errorCrm = new JLabel();
        errorCrm.setBounds(1207, 585, imgError.getIconWidth(), imgError.getIconHeight());
