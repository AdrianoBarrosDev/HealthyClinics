...
import healthyclinics.validacoes.ValidacaoCadastroProfissional;
...
public class TelaCadastrarProfissional implements ActionListener {
    ...
    private ValidacaoCadastroProfissional validacaoUsuario;
    
    
    public TelaCadastrarProfissional(ConfigFrame configFrame) {
    ...
    public TextFieldShadow getTxtCrm() {
        return txtCrm;
    }
    ...
    public void configCadastroProfissional() {
        ...
        validacaoUsuario = new ValidacaoCadastroProfissional(configFrame, this, layeredPane);
    ...
    public void configImages() {
        ...
        // Imagem da água
        ImageIcon imgWater = new ImageIcon(getClass().getResource("/imagens/WaterCircleProfissional.png"));
        JLabel lblWater = new JLabel();
        lblWater.setBounds(576, 0, imgWater.getIconWidth(), imgWater.getIconHeight());
        ...
        lblLogo.setBounds(136, -1, imgLogo.getIconWidth(), imgLogo.getIconHeight());
        lblLogo.setIcon(imgLogo);
        layeredPane.add(lblLogo, JLayeredPane.DEFAULT_LAYER);
        
        // Imagem retângulo
        ImageIcon imgRetangulo = new ImageIcon(getClass().getResource("/imagens/RectangleProfissional.png"));
        JLabel lblRetangulo = new JLabel();
        lblRetangulo.setBounds(0, 812, imgRetangulo.getIconWidth(), imgRetangulo.getIconHeight());
    ...
    public void configLabels() {
        ...
        lblNome.setBounds(224, 339, 245, 27);
        ...
        lblCpf.setBounds(224, 418, 245, 27);
        ...
        lblData.setBounds(224, 497, 245, 27);
        ...
        lblTelefone.setBounds(224, 576, 245, 27);
        ...
        lblEndereco.setBounds(224, 655, 245, 27);
        ...
        lblCrm.setBounds(224, 734, 245, 27);
        lblCrm.setForeground(new Color(0x395886));
        lblCrm.setFont(new Font("Volkhov", Font.PLAIN, 20));
        layeredPane.add(lblCrm, JLayeredPane.PALETTE_LAYER);
        
        // Texto "Senha"
        JLabel lblSenha = new JLabel("Senha");
        lblSenha.setBounds(224, 810, 245, 27);
    ...
    public void configLines() {
        ...
        lines.addLine(22, 21, 222, 21, 3, new Color(0x395886)); // Linha horizontal (canto superior esquerdo)
        lines.addLine(22, 21, 22, 221, 3, new Color(0x395886)); // Linha vertical (canto superior esquerdo)
        lines.addLine(702, 1057, 902, 1057, 3, new Color(0x395886)); // Linha horizontal (canto inferior direito)
        lines.addLine(902, 857, 902, 1057, 3, new Color(0x395886)); // Linha vertical (canto inferior direito)
    ...
    public void configTxt() {
        ...
        txtNome.setBounds(200, 366, 502, 55);
        ...
        txtCpf.setBounds(200, 445, 502, 55);
        ...
        txtData.setBounds(200, 524, 502, 55);
        ...
        txtTelefone.setBounds(200, 603, 502, 55);
        ...
        txtEndereco.setBounds(200, 682, 502, 55);
        ...
        // TextField para inserir o CRM
        txtCrm = new TextFieldShadow(45);
        txtCrm.setBounds(200, 761, 502, 55);
        txtCrm.setBackground(new Color(0xD5DEEF));
        txtCrm.setForeground(new Color(0x395886));
        txtCrm.setFont(new Font("Volkhov", Font.PLAIN, 15));
        layeredPane.add(txtCrm, JLayeredPane.MODAL_LAYER);
        
        // TextField para inserir a senha
        txtSenha = new TextFieldShadow(45);
        txtSenha.setBounds(200, 837, 502, 55);
    ...
    public void configBtns() {
        ...
        btnCadastrar.setBounds(348, 950, 206, 55);
        ...
        btnVoltar.setBounds(379, 1024, 144, 28);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == btnCadastrar) {
            ...
            ContaProfissional conta = validacaoUsuario.validarUser(txtNome.getText(), txtCpf.getText(), txtData.getText(), txtTelefone.getText(), txtEndereco.getText(), txtSenha.getText(), txtCrm.getText());
            ...
            if(conta != null) {
                ...
                // Adiciona a conta profissinal no banco de dados
                ContaProfissionalDAO daoProfissional = new ContaProfissionalDAO();
                daoProfissional.salvar(conta);
